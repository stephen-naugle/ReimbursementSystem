...
public class User {
	 ...
	 * @param role
	 */
	public User(int userId, String username, String password, String firstName, String lastName, String email, UserRoleEnum role) {
		super();
		this.userId = userId;
	...
	/**
	 * Creating new user from clientside
	 * @param username
	 * @param password
	 * @param firstName
	 * @param lastName
